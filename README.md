...
### Опыт работы
 ...
 #### [Thousand IT](https://thousand.kz) - Frontend разработчик (Vue/Nuxt)
  ...
  Обязанности и достижения:
   ...
   - Запустил и поддерживаю несколько публичных проектов, включая [Thousand IT](https://thousand.kz), [Sezapp](https://sezapp.kz), [Megaconcert](https://megaconcert.kz), [Japonica](https://japonica.kz).
-----------------------
